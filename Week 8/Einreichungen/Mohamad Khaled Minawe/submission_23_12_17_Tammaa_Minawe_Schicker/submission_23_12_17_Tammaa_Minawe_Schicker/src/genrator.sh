#!/bin/bash
#SBATCH --job-name=genratorJob
#SBATCH --output=genratorJob_output.txt
#SBATCH --error=genratorJob_error.txt
...
date
mpicxx -o genrator.o genrator.cpp
mpirun -np 2 -oversubscribe ./genrator.o
